        ...
        <section className="flex flex-col">
            ...
            <div className='w-full h-full px-4 sm:px-6 md:px-8 lg:px-12 xl:px-6 relative top-12 sm:top-16 md:top-20 lg:top-24 xl:top-29'>
                ...
                <div className="flex flex-col md:flex-row items-start md:items-end justify-start max-w-[1920px] mx-auto">
                    ...
                    <button className='absolute cursor-pointer font-mono uppercase flex justify-center items-center left-[55%] bottom-38 h-20 w-64 rounded-full border border-neutral-400 text-neutral-400 mix-blend-difference overflow-hidden'>
                        Let's level up
                    </button>
                </div>
