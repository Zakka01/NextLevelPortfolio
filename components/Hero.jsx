    ...
    return (
        <section className="w-full h-full px-8 md:px-10 relative top-12">
            <div className="max-w-[1920px] mx-auto pt-15">
                <h1 className="cursor-default text-[8rem] mix-blend-difference w-[70%] tracking-tight leading-26">
            ...
            <div className='flex flex-row justify-between w-full px-0 pt-18 h-full'>
                <button className='uppercase cursor-pointer text-[0.65rem] border border-neutral-400 px-10 rounded-full'>
                    let’s connect w/ me
                </button>
