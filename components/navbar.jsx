  ...
  return (
    <nav className="fixed z-100 w-full px-8 md:px-12 lg:px-5 mix-blend-difference">
      <div className="flex items-center justify-between max-w-[1920px] mx-auto">
        <div className="cursor-pointer pt-4 text-lg md:text-xl uppercase font-medium font-mono text-white tracking-tight translate-y-[-0.15rem] w-148 border-b border-neutral-500 pl-2 pb-2">
          Zack A.
        </div>
        <div className="flex items-center font-mono gap-2 md:gap-4 lg:gap-4">
          ...
          <div className="relative border-b border-neutral-500 hover:border-neutral-300 transitio-all duration-600 pt-2 pb-4 w-45">
            <a href="#whoami" className="pt-2 relative flex items-center gap-2 text-[0.7rem] md:text-[0.6rem] uppercase text-neutral-300 font-semibold tracking-wide group">
              <span className="w-2 h-2 rounded-full border border-neutral-700 mr-4 group-hover:h-0 group-hover:w-0 group-hover:opacity-0 duration-200"></span>
              ...
              <span className="absolute translate-x-18 w-0 h-0 rounded-full bg-white group-hover:translate-x-14 group-hover:h-7 group-hover:w-7 duration-300 overflow-hidden flex items-center justify-center">
                <Image src="/assets/arrow.png" width={14} height={14} alt="Arrow" className="opacity-5 group-hover:opacity-100 -rotate-40 transition-opacity duration-900" />
              </span>
            </a>
          </div>
          {/* Work */}
